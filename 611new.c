/* 611new.f -- translated by f2c (version 20050501).
...
integer i1mach_(integer *i__)
{
    ...
    static cilist io___15 = { 0, 6, 0, "(a,i12)", 0 };
    ...
    static cilist io___20 = { 0, 6, 0, "(a,i12)", 0 };
...
doublereal r1mach_(integer *i__)
{
    ...
    static cilist io___25 = { 0, 6, 0, "(a,i12)", 0 };
    ...
    static cilist io___30 = { 0, 6, 0, "(a,i12)", 0 };
...
/*    Output, real R1MACH, the value of the chosen parameter. */
	...
	ret_val = 1.1754944e-38f;
    } else if (*i__ == 2) {
	ret_val = 3.4028235e38f;
    } else if (*i__ == 3) {
	ret_val = 5.9604645e-8f;
    } else if (*i__ == 4) {
	ret_val = 1.1920929e-7f;
    } else if (*i__ == 5) {
	ret_val = .30103f;
    } else if (5 < *i__) {
	s_wsfe(&io___26);
...
#define model1 ((real *)&equiv_408)

    static struct {
	char e_1[24];
	real e_2;
	} equiv_409 = { " g   s  g-s s-g -s-g-g-s", 0.f };

#define model2 ((real *)&equiv_409)
    ...
    /* Fortran I/O blocks */
    static cilist io___370 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___371 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___373 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___374 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___375 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___376 = { 0, 0, 0, fmt_80, 0 };
    static cilist io___378 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___379 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___380 = { 0, 0, 0, fmt_140, 0 };
    static cilist io___381 = { 0, 0, 0, fmt_160, 0 };
    static cilist io___382 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___383 = { 0, 0, 0, fmt_200, 0 };
    static cilist io___384 = { 0, 0, 0, fmt_220, 0 };
    static cilist io___385 = { 0, 0, 0, fmt_240, 0 };
    static cilist io___386 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___387 = { 0, 0, 0, fmt_280, 0 };
    static cilist io___388 = { 0, 0, 0, fmt_300, 0 };
    static cilist io___389 = { 0, 0, 0, fmt_320, 0 };
    static cilist io___390 = { 0, 0, 0, fmt_340, 0 };
    static cilist io___391 = { 0, 0, 0, fmt_360, 0 };
    static cilist io___392 = { 0, 0, 0, fmt_380, 0 };
    static cilist io___393 = { 0, 0, 0, fmt_400, 0 };
    static cilist io___395 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___396 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___397 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___398 = { 0, 0, 0, fmt_80, 0 };
    static cilist io___399 = { 0, 0, 0, fmt_410, 0 };
    static cilist io___400 = { 0, 0, 0, fmt_420, 0 };
    static cilist io___402 = { 0, 0, 0, fmt_450, 0 };
    static cilist io___403 = { 0, 0, 0, fmt_460, 0 };
    static cilist io___404 = { 0, 0, 0, fmt_470, 0 };
    static cilist io___405 = { 0, 0, 0, fmt_490, 0 };
    static cilist io___406 = { 0, 0, 0, fmt_510, 0 };
    static cilist io___407 = { 0, 0, 0, fmt_530, 0 };
	...
	integer *liv, integer *lv, integer *n, doublereal *v)
{
	...
	char e_1[272];
	real e_2;
	} equiv_487 = { "epslon..phmnfc..phmxfc..decfac..incfac..rdfcmn..rdf"
...
#define varnm ((integer *)&equiv_488)
...
#define sh ((integer *)&equiv_489)

    static struct {
	char e_1[12];
	real e_2;
	} equiv_490 = { "---changed v", 0.f };

#define cngd ((real *)&equiv_490)

    static struct {
	char e_1[12];
	real e_2;
	} equiv_491 = { "nondefault v", 0.f };

#define dflt ((real *)&equiv_491)
    ...
    /* Fortran I/O blocks */
    static cilist io___462 = { 0, 0, 0, fmt_20, 0 };
    static cilist io___463 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___466 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___467 = { 0, 0, 0, fmt_90, 0 };
    static cilist io___474 = { 0, 0, 0, fmt_130, 0 };
    static cilist io___475 = { 0, 0, 0, fmt_160, 0 };
    static cilist io___476 = { 0, 0, 0, fmt_180, 0 };
    static cilist io___477 = { 0, 0, 0, fmt_220, 0 };
    static cilist io___478 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___479 = { 0, 0, 0, fmt_240, 0 };
    static cilist io___481 = { 0, 0, 0, fmt_260, 0 };
    static cilist io___482 = { 0, 0, 0, fmt_270, 0 };
    static cilist io___484 = { 0, 0, 0, fmt_310, 0 };
    static cilist io___485 = { 0, 0, 0, fmt_330, 0 };
    static cilist io___486 = { 0, 0, 0, fmt_350, 0 };
